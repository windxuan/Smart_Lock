...
* @{
*/
#define PRODUCT_KEY "c7f5288016fe4956850f7c5b0b6af88a"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "bb99de137ddb447d8c68ef1ea4026aea"

/**@name Device status data reporting interval
* @{
*/
#define REPORT_TIME_MAX 1000 //6S
/**@} */    
...
#define DOOR_BYTEOFFSET                    0
#define DOOR_BITOFFSET                     1
#define DOOR_LEN                           1

#define TEM_RATIO                         0.01
#define TEM_ADDITION                      -50
#define TEM_MIN                           0
#define TEM_MAX                           50
#define WEM_RATIO                         0.01
#define WEM_ADDITION                      0
#define WEM_MIN                           0
#define WEM_MAX                           100
/**@} */
